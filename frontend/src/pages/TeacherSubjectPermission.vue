<template>
    <div>
      <h2>กำหนดสิทธิ์การเข้าถึงรายวิชา</h2>
    ...
    <tbody>
      <tr v-for="subject in paginatedSubjects" :key="subject.id" class="hover:bg-gray-100">
        ...
        <td class="border border-gray-300 px-4 py-2 text-center">
          <router-link 
    class="bg-primary text-white font-semibold py-1 px-2 rounded-md shadow-md hover:bg-yellow-500 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" 
    :to="{ name: 'AdminStdList', params: { subCode: subject.sub_code } }" 
  >
    รายชื่อ นศ.
  </router-link>
        </td>
